...
public class PersonEntityTests {
	...
	public void getIdTest(){
		Person person = new Person(0, "firstName", "surname" , "01-01-1970" , 0);
	...
	@Test
	public void getIdAddressTest(){
		Person person = new Person(0, "firstName", "surname" , "01-01-1970" , 0);
		assertEquals(0,person.getIdAddress());	
	}	
	@Test
	...
	@Test
	public void setIdAddressTest(){
		Person person = new Person();
		person.setIdAddress(0);
		assertEquals(0,person.getIdAddress());	
	}
